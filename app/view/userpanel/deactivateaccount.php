...
<div class="alert alert-warning" role="alert">
  ...
  <hr>
  <p class="mb-0"><small>We're sad to see you go, but if you decide to come back, all you have to do is log in to reactivate your account.</small></p>
</div>
	<form action="<?= URL; ?>userpanel/processDeactivation" method="POST">
